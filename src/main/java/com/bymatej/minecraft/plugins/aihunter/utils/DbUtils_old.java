...
public class DbUtils_old {
    ...
    @Deprecated
    public static void storeHunterData(Hunter hunter) {
    ...
    @Deprecated
    public static void updateHunterCoordinates(Hunter hunter) {
        // todo: refactor and move the query to file: https://stackoverflow.com/a/12745238
    ...
    @Deprecated
    public static Hunter getHunterForName(String hunterName) {
        String query = String.format("SELECT * FROM hunter WHERE name = '%s';", hunterName);
